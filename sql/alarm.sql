...
CREATE TABLE `tb_device` (
  ...
  `manyTerm` varchar(64) NULL,                                                                                                                 
  `serverTerm` varchar(64) NULL,
  `clientTerm` varchar(64) NULL,
  `httpTerm` varchar(64) NULL,
  `mysqlTerm` varchar(64) NULL,
  `oracleTerm` varchar(64) NULL,
  `sqlserverTerm` varchar(64) NULL,
  `urlTerm` varchar(64) NULL,
  `messageTerm` varchar(64) NULL,
  `storeTerm` varchar(64) NULL,
  `mapTerm` varchar(64) NULL,
  `topoTerm` varchar(64) NULL,
  `pairTerm` varchar(64) NULL,
  `diggerTerm` varchar(64) NULL,
  PRIMARY KEY (`id`)
...
-- TODO 更改成管理员的信息
insert into tb_project(id, name, creater, create_time, comment) values(1, '告警系统', 'admin', unix_timestamp(now())*1000, '告警系统');
